  ...
  <div class="container mx-auto px-4 py-12 max-w-5xl">
    ...
    <div class="text-center mb-16">
      ...
      <p class="text-xl max-w-3xl mx-auto">
        Wir glauben an eine Zukunft, in der Style und Nachhaltigkeit Hand in Hand gehen.
      </p>
    </div>
    ...
    <section class="mb-16">
      <div class="bg-white p-8 md:p-12 rounded-xl shadow-lg">
        ...
        <p class="text-lg mb-4 leading-relaxed">
          ...
          Jeder unserer Schuhe wird mit Respekt für unseren Planeten hergestellt – von der
          Materialauswahl bis zur finalen Verpackung.
        </p>
        <p class="text-lg leading-relaxed">
          Wir kombinieren modernste Technologie mit zeitlosem Design und schaffen so Produkte,
          die nicht nur heute, sondern auch morgen noch relevant sind. Nachhaltigkeit ist für
          uns kein Trend, sondern eine Verpflichtung.
        </p>
      </div>
    </section>
      ...
      <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="bg-gray-50 p-6 rounded-xl border-l-4 border-shop-blue-light">
          ...
          <p class="">
            ...
            zeitlose Stücke, die in jeder Situation überzeugen.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="mb-16">
      <div class="bg-gradient-to-r from-shop-blue-dark to-shop-blue-light text-white p-8 md:p-12 rounded-xl">
        ...
        <p class="text-lg mb-4 leading-relaxed">
          ...
          teilten: Sneaker zu kreieren, die den Planeten nicht belasten. Was als kleines Startup
          in einer Garage begann, ist heute zu einer globalen Bewegung geworden.
        </p>
        <p class="text-lg leading-relaxed">
          Heute arbeiten wir mit über 50 nachhaltigen Lieferanten weltweit zusammen und haben
          bereits mehr als 15.000 Kunden dabei geholfen, einen positiven Fußabdruck zu hinterlassen –
